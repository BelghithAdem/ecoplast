    ...
    <main id="content">
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <ol class="flex items-center whitespace-nowrap">
                ...
                <li class="inline-flex items-center text-sm font-semibold text-gray-800 dark:text-white truncate"
                    aria-current="page">
                    Contact
                </li>
            </ol>
            ...
            <div class="grid md:grid-cols-2 items-center gap-12">
                <div>
                    ...
                    <p class="mt-1 md:text-lg text-gray-800 dark:text-neutral-200">
                        Lorem ipsum odor amet, consectetuer adipiscing elit. Urna ante et erat nulla aenean maximus
                        aptent vivamus.
                    </p>
                        ...
                        <form action="{{ route('contact.store') }}" method="POST">
                            ...
                            <div class="mt-6 grid gap-4 lg:gap-6">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                                    <div>
                                        <label for="first_name"
                                            class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Prénom</label>
                                    ...
                                    <div>
                                        <label for="last_name"
                                            class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Nom</label>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-1 gap-4 lg:gap-6">
                                    <div>
                                        <label for="company"
                                            class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Entreprise</label>
                                ...
                                <div>
                                    <label for="details"
                                        class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Détails</label>
                                    <textarea id="details" name="details" rows="4"
                                        class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mt-3 flex">
                                <div class="flex">
                                    <input id="remember-me" name="remember_me" type="checkbox"
                                        class="shrink-0 mt-1.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700">
                                </div>
                                <div class="ms-3">
                                    <label for="remember-me" class="text-sm text-gray-600 dark:text-neutral-400">En
                                        soumettant ce formulaire, j'ai lu et accepté la <a
                            ...
                            <div class="mt-6 grid">
                                <button type="submit"
                                    class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700">
                                    Envoyer la demande
                                </button>
                            </div>
                            ...
                            <div class="mt-3 text-center">
                                <p class="text-sm text-gray-500 dark:text-neutral-500">
                                    Nous reviendrons vers vous sous 1 à 2 jours ouvrés.
                                </p>
                            </div>
                        </form>
                        <!-- End Card -->
...
<body>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="er_bread_content">
                                ...
                                <div class="er_bread_list">
                                    ...
                                    <span class="er_active_page">Demande devis</span>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="er-contact_from">
                            <h4 class="er-title">Demande devis</h4>
                            @if (session('success'))
                                <div class="bg-green-100 text-green-700 p-4 rounded-lg mb-4">
                                    {{ session('success') }}
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="er-inputField">
                                            <input type="text" class="form-control require" placeholder="Nom"
                                                name="nom" id="nom" />
                                            @error('nom')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="er-inputField">
                                            <input type="text" class="form-control require" placeholder="Prenom"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="er-inputField">
                                            <input type="tel" class="form-control require"
                                                placeholder="Numero telephone" name="num_tel" id="num_tel">
                                            @error('num_tel')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="er-inputField">
                                            <input type="text" placeholder="Estimation temps" class="form-control"
                                                id="estimation_temps" name="estimation_temps">
                                            @error('estimation_temps')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                            @enderror
                                        </div>
    ...
    padding: 10px 40px 10px 10px;"
                                                name="methode_livraison" id="methode_livraison">
                                                <option value="1"
                                                    {{ old('methode_livraison') == '1' ? 'selected' : '' }}>Method 1
                                                </option>
                                                <option value="2"
                                                    {{ old('methode_livraison') == '2' ? 'selected' : '' }}>Method 2
                                                </option>
                                                <option value="3"
                                                    {{ old('methode_livraison') == '3' ? 'selected' : '' }}>Method 3
                                                </option>
                                            </select>
                                            @error('methode_livraison')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
