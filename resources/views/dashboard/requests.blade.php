...
<body class="bg-gray-50 dark:bg-neutral-900">
    ...
    <div class="w-full lg:ps-64 bg-white p-4 sm:p-6 space-y-4 sm:space-y-6 dark:bg-neutral-900">
        <div class="">
                        ...
                        <div
                            ...
                            <div>
                                <div class="inline-flex gap-x-2">
                                    <a href="/requests-avis/export-excel"
